...
To get started, type '{Fore.GREEN}LogFile.from_file("game.txt"){Fore.RESET}'
(if there is a file named game.txt in the same directory) or '{Fore.GREEN}LogFile.from_folder("logs"){Fore.RESET}'
(if your game.txt, attack.txt... are stored in a folder named logs)

Type '{Fore.GREEN}help(Log){Fore.RESET}' for information about the log,
and '{Fore.GREEN}help(LogFile){Fore.RESET}' for information about log files.
Type '{Fore.GREEN}functions(object){Fore.RESET}' for a list of all defined functions
and '{Fore.GREEN}variables(object){Fore.RESET}' for a list of all variables.
Both are currently quite bad (I will get to it some day I promise).

{Fore.CYAN}LogBuddy{Fore.RESET} performs all operations on an internal work set, so you can chain filters (functions).
To reset the work set, call '{Fore.GREEN}reset_work_set(){Fore.RESET}' on your log instance.

If {Fore.YELLOW}-- More --{Fore.RESET} is displayed on the bottom of the screen,
press {Fore.YELLOW}return (enter){Fore.RESET} to advance one line,
{Fore.YELLOW}space{Fore.RESET} to advance a screen or {Fore.YELLOW}q{Fore.RESET} to quit.
IPython (the thing you type in that displays 'In [2]:') will sometimes suggest commands.
The gray part can be inserted by simply pressing {Fore.YELLOW}→{Fore.RESET}.
Clear the current line by pressing {Fore.YELLOW}CTRL + C{Fore.RESET}.
You can exit by typing '{Fore.GREEN}exit{Fore.RESET}' or pressing {Fore.YELLOW}CTRL + D{Fore.RESET}.

For Python's interactive help, type '{Fore.GREEN}help(){Fore.RESET}',
or '{Fore.GREEN}help(object){Fore.RESET}' for help about object (for example: '{Fore.GREEN}help(LogFile){Fore.RESET}')."""
...
| |    / _ \ / _` | ___ \ | | |/ _` |/ _` | | | |
| |___| (_) | (_| | |_/ / |_| | (_| | (_| | |_| |
\_____/\___/ \__, \____/ \__,_|\__,_|\__,_|\__, | # noqa: W605
            __/ |                         __/ |
            |___/                         |___/
            {Fore.RESET}
...
For {Fore.CYAN}LogBuddy{Fore.RESET} specific help type '{Fore.GREEN}help{Fore.RESET}'
or '{Fore.GREEN}?{Fore.RESET}' for IPython's help (without the quotes).
""", colors="Neutral")
